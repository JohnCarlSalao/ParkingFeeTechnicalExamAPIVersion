...
from parkingfee.features.versions.v1p0.get_parking_fee_details.views.get_parking_fee_views import GetParkingFeeDetailsViews
from parkingfee.features.versions.v1p0.get_parking_fee.views.get_parking_fee_views import DisplayParkingFeeViews
...
from parkingfee.features.versions.v1p0.delete_parking_fee.views.delete_parking_views import DeleteParkingFeeViews


urlpatterns = [
    path('admin/', admin.site.urls),
    path('parking/add/create-parking-fee/', CreateParkingFeeViews.as_view(), name='create-parking-fee'),
    path('parking/get/parking-fee/',DisplayParkingFeeViews.as_view(), name ='parking-fee-detail' ),
    path('parking/get/parking-fee/<pk>/',GetParkingFeeDetailsViews.as_view(), name ='parking-fee-detail'),
    path('parking/delete/parking-fee/<pk>/',DeleteParkingFeeViews.as_view(), name ='delete-parking-fee'),
