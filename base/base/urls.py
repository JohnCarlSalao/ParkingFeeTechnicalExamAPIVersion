...
from parkingfee.features.versions.v1p0.add_parking_fee.views.create_parking_fee_views import CreateParkingFee
from parkingfee.features.versions.v1p0.create_car.views.create_car_views import CreateCar
from parkingfee.features.versions.v1p0.display_car.views.display_car_views import DisplayCar
...
urlpatterns = [
    ...
    path('parking/add/create-parking-fee', CreateParkingFee.as_view(), name='create-parking-fee'),
    path('car/create/', CreateCar.as_view(),name='create-car'),
    path('car/get/all/', DisplayCar.as_view(),name='display-all-car'),
